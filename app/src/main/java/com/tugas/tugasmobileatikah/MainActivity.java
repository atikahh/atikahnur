package com.tugas.tugasmobileatikah;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void openmaps(View v){
        ...
        Uri uri = Uri.parse("https://www.google.com/maps/search/semarang/@-6.977955, 110.406161");
    ...
    public void openemail(View v){
        ...
        i.putExtra(Intent.EXTRA_EMAIL  , new String[]{"nuratikah998@gmail.com"});
        try {
